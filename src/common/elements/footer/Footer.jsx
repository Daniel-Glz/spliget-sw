            ...
            <div className="col-lg-8 col-md-8">
              ...
              <div className="d-flex justify-content-start mt_sm--15 justify-content-md-end align-items-center flex-wrap">
                ...
                <ul className="social-icon color-tertiary md-size justify-content-start">
                  <li>
                    <a href="https://www.facebook.com/" rel="noopener" target="_blank" aria-label="Ir a cuenta de facebook">
                  ...
                  <li>
                    <a href="https://twitter.com/" aria-label="Ir a cuenta de Twitter">
                  ...
                  <li>
                    <a href="https://www.linkedin.com/" aria-label="Ir a cuenta de Linkedin">
